...
router.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const queryEmbedding = yield (0, ai_1.createEmbedding)(message);
        // 2. Get all document chunks for this user
        const { data: userDocuments, error: docsError } = yield service
            .from('documents')
            .select('id')
            .eq('user_id', userId);
        if (docsError) {
        ...
        const topChunks = chunksWithScores
            ...
            .slice(0, 3);
        console.log(`Found ${chunks.length} total chunks, using top 3 with scores:`, topChunks.map(c => c.score));
    ...
    `;
        ...
        const answer = yield (0, ai_1.generateChatResponse)(prompt);
